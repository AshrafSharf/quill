...
import PageBreakBlot from '../blots/pagebreak';
...
Toolbar.DEFAULTS = {
	...
	handlers: {
		...
		pagebreak: function () {
			...
			let pageBreakIndex = PageBreakBlot.determineBreakIndex(this.quill);
			this.quill.insertEmbed(range.index + 1, 'pagebreak', pageBreakIndex, Quill.sources.USER);
			this.quill.setSelection(range.index + 2, Quill.sources.SILENT);
		}
	}
}
